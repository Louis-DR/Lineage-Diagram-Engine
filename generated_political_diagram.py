...
lineage_M�P_1 = Lineage(diagram, '#66C52C', 10153.05, 284.5, 2.0, z=2.0)
lineage_M�P_1.terminate_at(10658.25)
lineage_RPF_1 = Lineage(diagram, '#021A6F', 10266.6, 462.5, 6.0, z=38.97415848921294)
lineage_RPF_1.terminate_at(11657.1)
lineage_C�_1 = Lineage(diagram, '#66C52C', 10291.8, 290.5, 2.0, z=2.0)
lineage_C�_1.terminate_at(10658.25)
...
lineage_L�_1 = Lineage.create_from_merge(diagram, '#66C52C', 10634.25, 10658.25, 287.5, 6.0, [lineage_M�P_1, lineage_C�_1], z=6.0)
lineage_PCF_1.shift_to(11037.6, 11366.4, 187.5)
lineage_L�_1.shift_to(11202.0, 11256.75, 227.5)
